...
"""
import pytest
from graphorm.properties import PropertiesManager, DefaultPropertiesValidator, PropertiesValidator
...
class TestDefaultPropertiesValidator:
    ...
    def test_validate_type_conversion(self):
        ...
        assert isinstance(result, int) or isinstance(result, str)  # May allow string for compatibility
